"""Tests for Advent of Code 2023 Day 11 Part 2."""
...
def test__calculate_solution_with_example_data() -> None:
    ...
    assert calculate_solution(Path(__file__).parent / "input/test__input") == 82000210


def test__calculate_solution_with_puzzle_data() -> None:
    """Test whether the calculated_solution matches the puzzle solution."""
    assert calculate_solution(Path(__file__).parent / "input/input") == 483844716556
