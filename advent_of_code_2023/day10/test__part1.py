"""Tests for Advent of Code 2023 Day 10 Part 1."""
...
def test__calculate_solution_with_simple_example_data() -> None:
    ...
    assert calculate_solution(Path(__file__).parent / "input/test__input_part1_simple") == 4
...
def test__calculate_solution_with_complex_example_data() -> None:
    ...
    assert calculate_solution(Path(__file__).parent / "input/test__input_part1_complex") == 8
